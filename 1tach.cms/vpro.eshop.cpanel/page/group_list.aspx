...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row page-header">
        <a href="groups.aspx" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped">
                    ...
                    <asp:Repeater ID="RplistGroup" runat="server" 
                        onitemcommand="RplistGroup_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <%# getOrder() %>
                                    <asp:HiddenField ID="Hdid" runat="server" Value='<%#Eval("GROUP_ID") %>' />
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href='<%# getLink(Eval("GROUP_ID")) %>'><span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <asp:LinkButton ID="lnkbtnDel" runat="server" CommandName="Delete" CommandArgument='<%#Eval("GROUP_ID") %>'
