...
namespace vpro.eshop.cpanel.page
{
    public partial class area : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Hyperback.NavigateUrl = "area_list.aspx";
            if (m_cat_id == 0)
            {
        ...
        private void getInfo()
        {
            try
            {
                ...
                if (G_info.ToList().Count > 0)
                {
                    ...
                    txtShippingFee.Value = Utils.CIntDef(G_info.ToList()[0].PROP_SHIPPING_FEE).ToString();
                    txtHomeFee.Value = G_info.ToList()[0].PROP_SHIP_NOTE;
                }
                else
                {
                    LoadCategoryParent();
