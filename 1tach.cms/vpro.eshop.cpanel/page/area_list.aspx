<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="area_list.aspx.cs" Inherits="vpro.eshop.cpanel.page.area_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row page-header">
        <a href="area.aspx" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped">
                    ...
                    <asp:Repeater ID="RplistArea" runat="server" 
                        onitemcommand="RplistArea_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <%# getOrder() %>
                                    <asp:HiddenField ID="Hdid" runat="server" Value='<%#Eval("PROP_ID") %>' />
                                </td>
                                <td>
                                    <input id="chkSelect" type="checkbox" name="chkSelect" runat="server">
                                </td>
                                <td>
                                    <a href='<%# getLink(Eval("PROP_ID")) %>'>
                                        <%# Eval("PROP_NAME")%>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <a href='<%# getLink(Eval("PROP_ID")) %>'><span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <asp:LinkButton ID="lnkbtnDel" runat="server" CommandName="Delete" CommandArgument='<%#Eval("PROP_ID") %>'
