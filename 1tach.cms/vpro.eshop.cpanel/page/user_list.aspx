...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row page-header">
        <a href="user.aspx" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped">
                    ...
                    <asp:Repeater ID="RplistUser" runat="server" 
                        onitemcommand="RplistUser_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <%# getOrder() %>
                                    <asp:HiddenField ID="Hdid" runat="server" Value='<%#Eval("USER_ID") %>' />
                                </td>
                                <td>
                                ...
                                <td>
                                    <%# getUserActive(Eval("USER_ACTIVE"))%>
                                </td>
                                <td class="text-center">
                                    <a href='<%# getLink(Eval("USER_ID")) %>'><span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <asp:LinkButton ID="lnkbtnDel" runat="server" CommandName="Delete" CommandArgument='<%#Eval("USER_ID") %>'
