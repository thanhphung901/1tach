...
namespace vpro.eshop.cpanel.page
{
    public partial class config_banner : System.Web.UI.Page
    {
        ...
        private void SearchResult()
        {
            try
            {
                ...
                var AllList = (from g in DB.ESHOP_BANNERs
                               ...
                               where ("" == keyword || (g.BANNER_DESC).Contains(keyword))
                               select g);
                ...
                RplistBanner.DataSource = AllList;
                RplistBanner.DataBind();
        ...
        protected void RplistBanner_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
