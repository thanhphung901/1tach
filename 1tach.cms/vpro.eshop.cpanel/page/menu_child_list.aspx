<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="menu_child_list.aspx.cs" Inherits="vpro.eshop.cpanel.page.menu_child_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row page-header">
        <a href="menu_child.aspx" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped">
                    ...
                    <asp:Repeater ID="RplistMenu" runat="server" 
                        onitemcommand="RplistMenu_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <%# getOrder() %>
