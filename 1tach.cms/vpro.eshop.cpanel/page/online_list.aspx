<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="online_list.aspx.cs" Inherits="vpro.eshop.cpanel.page.online_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row page-header">
        <a href="online.aspx" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    Danh sách hỗ trợ trực tuyến</h3>
            </div>
            <div class="panel-body table-responsive">
                <table class="table table-striped">
                    ...
                    <asp:Repeater ID="RplistOnline" runat="server" OnItemCommand="RplistOnline_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <%# getOrder() %>
                                    <asp:HiddenField ID="Hdid" runat="server" Value='<%#Eval("ONLINE_ID") %>' />
                                </td>
                                <td>
                                    <input id="chkSelect" type="checkbox" name="chkSelect" runat="server">
                                </td>
                                <td>
                                    <a href='<%# getLink(Eval("ONLINE_ID")) %>'>
                                ...
                                <td>
                                    <%# getType(Eval("ONLINE_TYPE"))%>
                                </td>
                                <td class="text-center">
                                    <a href='<%# getLink(Eval("ONLINE_ID")) %>'><span class="glyphicon glyphicon-pencil">
                                    </span></a>
                                </td>
                                <td class="text-center">
                                    <asp:LinkButton ID="lnkbtnDel" runat="server" CommandName="Delete" CommandArgument='<%#Eval("ONLINE_ID") %>'
