...
{
    public partial class config_slogan : System.Web.UI.Page
    {
        #region Declare
        ...
        private void showFileHTML()
        {
            try
            {
                ...
                pathFile = Server.MapPath(PathFiles.GetPathFooter() + "/trichdan-tren.htm");
        ...
        private void SaveHTMLInfo()
        {
            try
            {
                ...
                strFileName = PathFiles.GetPathFooter() + "/trichdan-tren.htm";
