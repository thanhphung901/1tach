...
{
    public partial class config_video : System.Web.UI.Page
    {
        #region Declare
        ...
        private void showFileHTML()
        {
            try
            {
                ...
                pathFile = Server.MapPath(PathFiles.GetPathFooter() + "/video-vi.htm");
        ...
        private void SaveHTMLInfo()
        {
            try
            {
                ...
                strFileName = PathFiles.GetPathFooter() + "/video-vi.htm";
